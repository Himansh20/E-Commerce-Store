...
const CreateCategory = () => {
  ...
  const handleChange = (e) => {
    ...
    // Check if input value contains only one alphabetical character
    if (inputValue === "" || /^[a-zA-Z]+$/.test(inputValue)) {
      setName(inputValue);
    } else {
      // If input value does not match the pattern, show an error message
      toast.error("Category name should contain only alphabetical character");
    }
  };
